...
def run_verification(N=400):
    print(f"--- Верификация для матриц {N}x{N} ---")
    ...
    print("Вычисление эталона (NumPy)...")
